...
from modeld5 import nvidia_model
from opticalHelpers import opticalFlowDense
from opticalHelpers import opticalFlowOverlay
...
for idx in tqdm(range(1, len(data) - 1)):
    ...
    x2_copy = cv2.resize(dst, (640, 480), interpolation = cv2.INTER_AREA)
...
clip.write_videofile("movie_5_withOverlay.mp4", fps = 13)
